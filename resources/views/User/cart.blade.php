                                ...
                                <tr>
                                    <td class="align-middle">
                                        <figure class="pt-4 figure d-flex justify-content-evenly">
                                            <img src="{{ asset('img/1.jpg') }}" class="figure-img img-fluid rounded"
                                                alt="gambar produk">
                                            <figcaption class="figure-caption">
                                                <a href="produk-one.html" class="text-decoration-none">
                                                    <h4 class="hampat-cart">Benang Jahit</h4>
                                                </a>
                                                <p class="p-cart">Barang yang kami jual merupakan produk dari toko kami
                                                </p>
                                            </figcaption>
                                        </figure>
                                    </td>
